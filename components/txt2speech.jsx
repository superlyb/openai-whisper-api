...
export default function txt2speech(text){
    const subscriptionKey = NEXT_PUBLIC_TTS_ACCESS_KEY_ID;
    const serviceRegion = NEXT_PUBLIC_TTS_REGION; // e.g., "westus"
   ...
   // speechConfig.speechSynthesisVoiceName = "zh-CN-henan-YundengNeural";
    ...
    const speechSynthesisVoiceName = NEXT_PUBLIC_SPEECHNAME;
    const ssmlText = `
    <speak version='1.0' xmlns='http://www.w3.org/2001/10/synthesis' xmlns:mstts='https://www.w3.org/2001/mstts' xml:lang='zh-CN'>
      <voice name="${speechSynthesisVoiceName}">
          <mstts:express-as style='${NEXT_PUBLIC_SPEECHSTYLE}' styledegree='2'>
              ${results}
          </mstts:express-as>
      </voice>
    </speak>`;
